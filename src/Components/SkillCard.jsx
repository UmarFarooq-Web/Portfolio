...
const SkillCard = ({ name, level, icon, description, index }) => {
            ...
            <div className={`glass-effect sm:p-6 p-4 rounded-lg neon-border  hover:shadow-[0_0_30px_rgba(0,255,255,0.3)] transition-all duration-300 transform hover:-translate-y-2`}>
                ...
                <div className="mb-4">
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
                        <motion.div
                            className="h-full bg-gradient-to-r from-[#00ffff] to-[#bf00ff] rounded-full shadow-[0_0_10px_rgba(0,255,255,0.5)]"
                            initial={{ width: 0 }}
